...
export const productConfigs: Record<string, ContentPageConfig> = {
  "ai-automation": {
    ...
    description:
      "Automate any repetitive process — from customer operations to back-office workflows — with AI that understands context, takes action and learns from every run.",
    features: {
    ...
    splits: [
      {
        ...
        description:
          "Design, deploy and monitor every workflow in a single unified interface — no more chasing scripts across teams.",
        bullets: [
  ...
  "ai-agents": {
    ...
    description:
      "Deploy autonomous, tool-using agents that reason across your systems, take actions and hand off to humans with full context — enterprise-safe by default.",
    features: {
    ...
    splits: [
      {
        ...
        description:
          "From support triage to procurement to internal helpdesks — teams deploy Pascual.ai agents where a workflow used to live.",
        bullets: [
  ...
  "custom-ai-development": {
    ...
    description:
      "Purpose-built models, retrieval systems and AI applications designed around your data, workflows and constraints — delivered by senior AI engineers.",
    features: {
  ...
  "enterprise-ai-solutions": {
    ...
    description:
      "The Pascual.ai platform brings agents, automation, custom models and governance together — with the security, compliance and support enterprises require.",
    features: {
    ...
    splits: [
      {
        ...
        description:
          "Agents, workflows, models, retrieval, evals and analytics — consolidated on Pascual.ai.",
        bullets: [
  ...
  "web-applications": {
    ...
    description:
      "We design and engineer performant, accessible, delightful web products — from customer-facing platforms to complex internal tools.",
    features: {
  ...
  "mobile-applications": {
    ...
    description:
      "iOS and Android apps built by senior mobile engineers who care about performance, accessibility, offline behavior and long-term maintainability.",
    features: {
  ...
  "saas-platforms": {
    ...
    description:
      "We architect and build SaaS platforms with the tenancy, billing, security and reliability that enterprise buyers demand.",
    features: {
  ...
  "internal-business-systems": {
    ...
    description:
      "Custom ERPs, CRMs, ops consoles and admin portals that fit exactly how your business runs — and that people actually love using.",
    features: {
  ...
  "cloud-integration": {
    ...
    description:
      "Unify AWS, Azure, GCP and private cloud in a coherent architecture that supports every workload — from AI to compliance-heavy systems.",
    features: {
      eyebrow: "Capabilities",
      items: [
        {
  ...
  "api-development": {
    ...
    description:
      "REST, GraphQL and event-driven APIs designed with versioning, docs, SDKs and observability from day one.",
    features: {
      eyebrow: "What you get",
      items: [
  ...
  devops: {
    ...
    description:
      "CI/CD, infrastructure-as-code, observability and platform engineering — built so every team can ship safely without waiting on ops.",
    features: {
      eyebrow: "Practices",
      items: [
        {
  ...
  "system-architecture": {
    ...
    description:
      "Deep architecture engagements to design systems that are performant, evolvable, secure and financially sustainable at scale.",
    features: {
  ...
  "business-intelligence": {
    ...
    description:
      "From raw data to trusted dashboards — modeled, governed and delivered so every decision is data-informed.",
    features: {
  ...
  "data-analytics": {
    ...
    description:
      "Modern data stack engagements: ingestion, modeling, warehousing, transformation and activation — done right, once.",
    features: {
      eyebrow: "Capabilities",
      items: [
  ...
  "ai-insights": {
    ...
    description:
      "Go beyond dashboards. Forecast, classify, cluster and recommend — with models delivered into the tools your teams already use.",
    features: {
  ...
  "reporting-dashboard": {
    ...
    description:
      "Beautiful, real-time dashboards for executives, operators and analysts — designed by our team, powered by your data.",
    features: {
      eyebrow: "Features",
      items: [
      ...
      splits: [
        {
          ...
          description:
            "Every industry has its own operational reality. These are the challenges we most often hear from leaders in this space.",
...
export const serviceConfigs: Record<string, ContentPageConfig> = {
  "ai-consulting": {
    ...
    description:
      "Turn AI ambition into an executable plan. Our consultants combine deep industry expertise with hands-on engineering to identify, prioritize and scope high-value AI initiatives.",
    timeline: {
  ...
  "digital-transformation": {
    ...
    description:
      "Reinvent how your business operates end-to-end. We combine strategy, product, engineering and AI to deliver transformations that stick.",
    features: {
  ...
  "software-development": {
    ...
    description:
      "Senior engineering pods that ship product every two weeks — with the design, quality and operational maturity of a great startup, at enterprise scale.",
    features: {
      eyebrow: "How we work",
      items: [
        {
  ...
  "cloud-migration": {
    ...
    description:
      "Move to modern cloud infrastructure with a partner that has done it 200+ times — safely, cost-effectively, and without disrupting the business.",
    steps: {
  ...
  "ux-ui-design": {
    ...
    description:
      "Design leadership and hands-on craft to make your products faster to use, easier to sell and impossible to churn from.",
    features: {
  ...
  "product-strategy": {
    ...
    description:
      "Sharpen positioning, define north-star metrics and build the roadmap that gets your product from where it is to where it needs to be.",
    features: {
      eyebrow: "Deliverables",
      items: [
  ...
  "maintenance-support": {
    ...
    description:
      "Post-launch care from the same senior teams that built your product — proactive monitoring, rapid response and continuous improvement.",
    features: {
...
export const companyConfigs: Record<string, ContentPageConfig> = {
  about: {
    ...
    description:
      "Pascual.ai was founded on a simple idea: the world's largest organizations deserve an AI partner that can deliver, not just advise. We combine strategy, product, engineering and AI research under one roof.",
    features: {
  ...
  team: {
    ...
    description:
      "Engineers, designers, researchers and operators from the world's most demanding technology companies.",
    features: {
      eyebrow: "Our team",
      items: [
        {
  ...
  partners: {
    ...
    description:
      "Join our partner ecosystem — from technology integrations to solution providers extending Pascual.ai to more industries.",
    features: {
  ...
  news: {
    ...
    description:
      "Product launches, customer stories, research and press coverage from the Pascual.ai team.",
    cards: {
      eyebrow: "Latest",
      heading: "Recent news",
      items: [
