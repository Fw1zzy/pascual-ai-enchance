  ...
  head: () => ({
    meta: [
      { title: "Careers — Pascual.ai" },
      {
        name: "description",
        content:
          "Join Pascual.ai. Work with senior operators solving the hardest problems in enterprise AI.",
      },
    ],
  }),
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        secondary={{ label: "Meet the team", href: "/company/team" }}
      />
      <Section>
            ...
            >
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  {r.team} · <MapPin className="mr-0.5 inline h-3 w-3" />
                  {r.location}
                </p>
              </div>
              <span className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-white px-3 py-1.5 text-xs font-medium">
